...
_G.packer_plugins = {
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/Users/babatunde.aromire@cognitedata.com/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
